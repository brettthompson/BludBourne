...
public class TownMap extends Map{
    ...
    private static String _townInnKeeper = "scripts/town_folk.json";
    ...
    TownMap(){
        ...
        _mapEntities.add(intitSpecialEntity(Entity.getEntityConfig(_townInnKeeper)));
    ...
    privat Entity initSpecialEntity(EntityConfig entityConfig){
        Vector2 position = new Vector2(0,0);

        if(_specialNPCStartPositions.containsKey(
                entityConfig.getEntityID())) {
            position = _specialNPCStartPositions.get(
                    entityConfig.getEntityID());
        }
