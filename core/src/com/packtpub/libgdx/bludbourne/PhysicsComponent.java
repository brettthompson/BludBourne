...
public abstract class PhysicsComponent implements Component {
    ...
    protected BoundingBowLocation _boudningBoxLocation;
    ...
    protected boolen isCollisionWithMapLayer(Entity entity, MapManager mapMgr){
    ...
    protected void updateBoundingBoxPosition(Vector2 position){
        //need to account for unit scale, since the map coordinates will be pixels
        float minX;
        float minY;
