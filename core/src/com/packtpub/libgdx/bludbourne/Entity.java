...
public class Entity {
    ...
    private static final String _defaultSpritePath = "sprite/characters/Warrior.png";
    ...
    public void setBoundingBoxSize(float percentageWidthReduced, float percentageHeight){
        ...
        //need to aaccount for the unitscale, since the map coordinates will be in pixels
        float minX;
        float minY;
    ...
    public void setDirection(Direction direction, float deltaTime){
        ...
        switch (_currentDirection){
            ...
            case LEFT :
                ...
                break;
            case UP : _currentFrame = _walkUpAnimation.getKeyFrame(_frameTime);
                break;
            case RIGHT :
    ...
    public void calculateNextPosition(Direction currentDirection, float deltaTime){
        ...
        switch (currentDirection) {
            ...
            case RIGHT :
                testX += _velocity.x;
                break;
            case UP : testY += _velocity.y;
                break;
            case DOWN : testY -= _velocity.y;
                break;
                default:
                break;
        }
